...
// Project: http://github.com/polem/ipp
...
export class Printer {
  constructor(url: string | UrlWithStringQuery, options?: PrinterOptions);
  ...
  execute(
    ...
    message: CUPSAddModifyPrinterRequest,
    callback?: (error: Error, response: SimpleResponse) => void,
  ): void;
  execute(
    operation: 'CUPS-Delete-Printer',
    message: CUPSDeletePrinterRequest,
    callback?: (error: Error, response: SimpleResponse) => void,
  ): void;
}
...
export interface CUPSAddModifyPrinterRequest {
  'operation-attributes-tag': {
    'printer-uri': string;
  };
  'printer-attributes-tag': {
    'banner-end-default'?: string | undefined;
    'banner-start-default'?: string | undefined;
    ...
    'requesting-user-name-allowed'?: string[] | undefined;
    'requesting-user-name-denied'?: string[] | undefined;
  }
}

export interface CUPSDeletePrinterRequest {
  'operation-attributes-tag': {
    'printer-uri': string;
  }
}
